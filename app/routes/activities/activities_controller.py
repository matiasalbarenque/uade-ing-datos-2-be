...
@router.post("/{activity_id}/like", dependencies=[Depends(JWTBearer())], tags=[entity])
...
@router.put("/{activity_id}", dependencies=[Depends(JWTBearer())], tags=[entity])
...
@router.get("/{activity_id}", dependencies=[Depends(JWTBearer())], tags=[entity])
